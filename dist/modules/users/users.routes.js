...
usersRouter.patch("/me/removeFavPlayer", protectedRoutes_1.default, validator.body(users_validation_1.removeFavPlayerVal), users_controller_1.removeFavPlayer);
usersRouter.patch("/me/removeFavTeam", protectedRoutes_1.default, validator.body(users_validation_1.removeFavTeamVal), users_controller_1.removeFavTeam);
usersRouter.patch("/me/changePassword", protectedRoutes_1.default, validator.body(users_validation_1.changePasswordVal), users_controller_1.changePassword);
usersRouter.patch("/me/updateProfile", protectedRoutes_1.default, upload_1.uploadImage.fields([{ name: "avatar", maxCount: 1 }]), validator.body(users_validation_1.updateProfileVal), users_controller_1.updateProfile);
